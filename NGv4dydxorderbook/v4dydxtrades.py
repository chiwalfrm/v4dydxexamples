...
from v4dydxtradesclient import process_message
        ...
        def run(self):
                ...
                while True:
                        ...
                        if msg is None:
                                ...
                                mycursor = conn.execute("UPDATE v4tserver SET messageid = "+str(json.loads(msg)['message_id'])+" WHERE market1 = '"+market+"';")
                                conn.commit()
...
def main():
        global pool
        mycursor = conn.execute("DELETE FROM v4tserver WHERE market1 = '"+market+"';")
        conn.commit()
        mycursor = conn.execute("INSERT INTO v4tserver VALUES ('"+market+"', -1);")
        conn.commit()
